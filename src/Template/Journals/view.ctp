...
<div class="row">
  ...
  <div class="col-md-3">
	<div class="list-group">
	  <?= $this->Html->link('<i class="fas fa-edit" aria-hidden="true"></i> ' . __('Edit Journal'), ['action' => 'edit', $journal->id, '?' => ['back' => $back]], ['class' => 'list-group-item', 'escape' => false]) ?>
	  <?= $this->Html->link('<i class="fas fa-copy" aria-hidden="true"></i> ' . __('Copy Journal'), ['action' => 'add', '?' => ['b' => $journal->id, 'back' => $back]], ['class' => 'list-group-item', 'escape' => false]) ?>
	  <?= $this->Form->postLink('<i class="fas fa-trash" aria-hidden="true"></i> ' . __('Delete Journal'), ['action' => 'delete', $journal->id], ['confirm' => __('Are you sure you want to delete # {0}?', $journal->id), 'class' => 'list-group-item', 'escape' => false]) ?>
	</div>
	<div class="list-group">
